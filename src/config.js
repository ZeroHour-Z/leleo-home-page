const config = {
  ...
  metaData:{
    title: 'ZeroHour',
    description: '欢迎来到ZeroHour的奇妙世界！',
    keywords: 'ZeroHour,ZeroHour,个人主页,个人网站',
    icon: '/favicon.ico'   //网页图标，支持外链
  },

  avatar: "/img/avatar.jpg", // 头像
  welcometitle: "Hi, I'm Zerohour", // 标题
  ...
  //社交按钮
  socialPlatformIcons: [
    {icon:"mdi-github",link:"https://www.github.com/ZeroHour-Z"},
  ...
  statement: ["备案号：XXICP备123456789号","Copyright © 2025 ZeroHour"],
}
